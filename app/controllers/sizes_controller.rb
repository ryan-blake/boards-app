class SizesController < ApplicationController
  ...
  def sort_direction
    ...
    def size_params
      params.require(:size).permit(:kind_id, :brand ,:price, :inventory, :color, :title, :type_id, :category_id, :user_id, :board_id,images_files: [], images_attributes: [ :id, :file, :_destroy])
    end
