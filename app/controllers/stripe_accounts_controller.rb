class StripeAccountsController < ApplicationController
      ...
      begin
        ...
        account = Stripe::Account.create(
          ...
          legal_entity: {
            ...
            business_name: account_params[:business_name],
            dob: {
  ...
  def edit
    ...
    unless @stripe_account.verification.fields_needed.present?
  ...
  def update
    ...
    @stripe_account.verification.fields_needed.each do |field|
      # Reject empty values
      unless account_params[field.to_sym].present?
      ...
      #   @stripe_account.legal_entity.business_name = account_params[field.to_sym]
    ...
    begin
      ...
      redirect_to dash_path and return
    rescue Stripe::RateLimitError => e
      flash[:alert] = e.message
      render 'edit'
    rescue Stripe::InvalidRequestError => e
  ...
  private
    def account_params
      params.require(:stripe_account).permit(
        :first_name, :last_name, :account_type, :dob_month, :dob_day, :dob_year, :tos, :legal_entity, :business_name, :city, :line1, :state, :postal_code, :ssn_last_4,
        :'legal_entity.first_name', :'legal_entity.last_name', :'legal_entity.business_name', :'legal_entity.address.city',
