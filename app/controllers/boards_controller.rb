class BoardsController < ApplicationController
 ...
 def search_signed_in
  ...
  private
    ...
    def board_params
      params.require(:board).permit(:address, :customer_id, :shipped, :shipping, :for_sale, :pending, :title, :description, :arrived, :user_id, :price, :lendth, :make, :age, :footgear, :width, :length, :name, :type_id, :category_id, :volume, :address, :city, :state, :zipcode, images_files: [])
    end
