...
def update_boards
  ...
  def cat2type(cat)
    ...
    def board_params
      params.require(:board).permit(:upc ,:tracking, :customer_id, :shipped, :shipping, :for_sale, :pending, :title, :description, :arrived, :user_id, :price, :lendth, :make, :used, :footgear, :width, :length, :name, :type_id, :category_id, :tail_id, :fin_id, :list_time, :volume, :address,
      :city, :cost, :margin, :company, :state, :remote_image_url, :zipcode, :inventory, images_files: [], images_attributes: [ :id, :file, :_destroy], accessories_attributes: [:id, :measured, :measure, :unit_id, :price, :color, :inventory, :kind_id, :title, :user_id, :board_id, :category_id, :brand,
