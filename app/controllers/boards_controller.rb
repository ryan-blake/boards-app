...
def update_boards
  ...
  def cat2type(cat)
    ...
    def board_params
      params.require(:board).permit(:sale_price, :shippable, :rate, :upc ,:tracking, :customer_id, :shipped, :shipping, :for_sale, :pending, :title, :description, :arrived, :user_id, :price, :lendth, :make, :used, :footgear, :width, :length, :name, :type_id, :category_id, :tail_id, :fin_id, :list_time, :volume, :address,
